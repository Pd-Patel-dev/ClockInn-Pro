...
class TimeEntry(Base):
    ...
    source = Column(Enum(TimeEntrySource), nullable=False, default=TimeEntrySource.KIOSK)
    note = Column(String(500), nullable=True)
    status = Column(Enum(TimeEntryStatus), nullable=False, default=TimeEntryStatus.OPEN)
