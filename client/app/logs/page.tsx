  ...
  return (
    <Layout>
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-900 mb-1">My Time Logs</h1>
          <p className="text-sm text-gray-600">View and track your time entries</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
          <h2 className="text-sm font-medium text-gray-900 mb-3">Filter by Date</h2>
